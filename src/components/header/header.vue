<template>
  <header class="header">
    ...
    <div class="navbar">
        ...
        <div class="navbar-right-container" style="display: flex;">
          <div class="navbar-menu-container">
            ...
            <a href="javascript:void(0)" class="navbar-link" @click="logFlag" v-if="!nickName">Login</a>
    ...
    <div class="md-overlay" v-show="loginModalFlag" @click="close"></div>
  </header>
</template>

<script>
import './../../assets/css/login.css'
import {userLogin, userLogOut, checkLogin, getCartCount} from '@/api/user'
